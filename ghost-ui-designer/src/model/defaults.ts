    ...
    layers: [
      ...
      layer('Bola', {
        ...
        effects: [
          ...
          fx('env', { sky: 'rgba(255,255,255,0.9)', ground: 'rgba(0,0,0,0.7)' }),
          fx('dish', { offset: 0.55 }),
  ...
  return {
    ...
    layers: [
      ...
      layer('Palanca', {
        ...
        effects: [
          fx('dropShadow', { distance: 4, blur: 8, color: 'rgba(0,0,0,0.7)', useLight: true }),
          fx('env', { sky: 'rgba(255,255,255,0.8)', ground: 'rgba(0,0,0,0.6)' }),
          fx('bevel', { size: 3 }),
          fx('specular', { size: 0.5, aspect: 3, strength: 0.9 }),
          fx('rim', { size: 1.5 }),
        ],
      }),
      layer('Remate', {
        ...
        effects: [
          ...
          fx('env', { sky: 'rgba(255,255,255,0.9)', ground: 'rgba(0,0,0,0.65)' }),
          fx('dish', { offset: 0.5 }),
